...
BASE = "/root/hdd"
BASE_PATH = ""
VALID_JSON = "GANHands_test.json"
TRAIN_JSON = "GANHands_train.json"
...
def _parse_function(imgId, is_train, ann=None):
    ...
    #img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=6.5)
    #img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=5.5)
    #img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=4.0)
    #img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=5.0)
    img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=8.0)
    #img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=7.0)
    #img_meta_data = CocoMetadata(idx, img_path, img_meta, img_anno, sigma=10.0)
